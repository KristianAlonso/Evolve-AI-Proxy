...
import { createNoopLogger, type TraceLogger } from './logging.js';
import type { Phase, SSEEvent } from './agent-events.js';
...
export class AgentLoop {
  ...
  private resolvedOptions() {
    return {
      ...
      compact_threshold: this.opts.compact_threshold ?? 0.9,
