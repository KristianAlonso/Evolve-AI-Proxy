...
// The TraceLogger contract is owned by the domain; this module implements it. Re-exported so
// existing `import { createLogger, type TraceLogger }` sites keep working.
